...
UBUNTU_TRANSLATION_DOMAIN="qml-layout.larreamikel"
...
aptest.commands = bash $$PWD/Qml-Layout/tests/autopilot/run
aptest.depends  = sub-Qml-Layout

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/Qml-Layout/tests/unit 
unittest.depends  = sub-Qml-Layout
